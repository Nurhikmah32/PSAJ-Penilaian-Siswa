...
<head>
    ...
    <title>Dashboard Penilaian SMK</title>
...
<body class="bg-gray-50">
    <aside class="sidebar">
        <div class="p-4">
            ...
            <nav class="space-y-2">
                <a href="../admin/dashboard.php" class="nav-link text-white bg-blue-500/20">
                    <i class="fas fa-home mr-3"></i> Dashboard
                </a>
                <a href="../admin/data_siswa.php" class="nav-link text-white bg-blue-500/20">
                    <i class="fas fa-user-graduate mr-3"></i> Siswa
                </a>
                <a href="../admin/mapel.php" class="nav-link text-white bg-blue-500/20">
                    <i class="fas fa-book-open mr-3"></i> Mata Pelajaran
                </a>
                <a href="../admin/penilaian.php" class="nav-link text-white bg-blue-500/20">
                    <i class="fas fa-file-signature mr-3"></i> Penilaian
                </a>
                <a href="../admin/laporan.php" class="nav-link text-white bg-blue-500/20">
                    <i class="fas fa-file-alt mr-3"></i> Laporan
                </a>
                <a href="#" class="nav-link text-white bg-blue-500/20" onclick="confirmLogout(); return false;">
    ...
    <main id="mainContent">
        ...
        <div class="p-6">
            <div class="notification" id="notification">Logout Berhasil!</div>
    ...
    <script>
        ...
        function confirmLogout() {
            if (confirm("Apakah Anda yakin ingin logout?")) {
                // Tampilkan notifikasi dan arahkan ke login setelah 1 detik
                showNotification();
                setTimeout(() => {
                    window.location.href = 'http://localhost/penilaian_siswa_smk/login.php';
                }, 1000);
            }
        }
